...
- `SERVITECH_ALLOW_WORD_COM_RENDERER` (optional local-development fallback only; disabled by default because Microsoft Word COM automation is not reliable for unattended web requests)
