...
<head>
  ...
  <link rel="stylesheet" href="<?= htmlspecialchars(servitech_url('/assets/css/style.css?v=20260511announce3'), ENT_QUOTES, 'UTF-8') ?>">
</head>
<body>
  ...
  <script src="/assets/js/main.js?v=20260511landing4"></script>
