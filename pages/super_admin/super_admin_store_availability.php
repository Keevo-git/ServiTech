  ...
  <header class="store-settings-hero">
    <div class="store-settings-hero-copy">
      ...
      <div class="store-settings-hero-actions" aria-label="Store Availability actions">
        ...
        <a class="hero-btn hero-btn-primary" href="<?= admin_url('/pages/super_admin/super_admin_announcement.php') ?>">Announcements</a>
      </div>
    </div>
...
<?php require __DIR__ . "/../admin/_includes/admin_footer.php"; ?>
<script>
