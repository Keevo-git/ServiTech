...
<head>
  ...
  <title>Errors, Corrections & Data Quality | ServiTech</title>
...
<main class="container main-container analytics-page analytics-report-page">
  <?php analytics_render_report_header("Errors, Corrections & Data Quality", "Identify incomplete records, corrected requests, duplicate requests, missing details, and possible miscommunication indicators.", $context); ?>
  ...
  <?php else: ?>
    ...
    <?php analytics_render_filters($context, "super_admin_analytics_quality.php", ["cycle", "date", "service", "status", "source"]); ?>
    <?php analytics_render_quality($context); ?>
    <?php analytics_render_export_row($context, "super_admin_analytics_quality.php"); ?>
  <?php endif; ?>
</main>
