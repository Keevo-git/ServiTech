...
<head>
  ...
  <title>Communication & Notifications | ServiTech</title>
...
<main class="container main-container analytics-page analytics-report-page">
  <?php analytics_render_report_header("Communication & Notifications", "Review customer update activity, notification delivery, unread notifications, and missing update records.", $context); ?>
