...
<head>
  ...
  <title>Service Completion & Cancellation | ServiTech</title>
...
<main class="container main-container analytics-page analytics-report-page">
  <?php analytics_render_report_header("Service Completion & Cancellation", "Track completed requests, cancelled requests, cancellation reasons, and completion time by service type.", $context); ?>
  ...
  <?php else: ?>
    ...
    <?php analytics_render_filters($context, "super_admin_analytics_completion.php", ["cycle", "date", "service", "source"]); ?>
    <?php analytics_render_completion($context); ?>
    <?php analytics_render_export_row($context, "super_admin_analytics_completion.php"); ?>
  <?php endif; ?>
</main>
