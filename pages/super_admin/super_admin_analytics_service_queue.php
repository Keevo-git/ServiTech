...
if ($context["ready"] && strtolower(trim((string)($_GET["export"] ?? ""))) === "csv") {
    analytics_send_csv_export($pdo, $context, "service_queue", "Service Requests & Queue Performance", "servitech-service-requests-queue-performance.csv");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<main class="container main-container analytics-page analytics-report-page">
  ...
  <?php else: ?>
    <?php analytics_render_filters($context, "super_admin_analytics_service_queue.php", ["cycle", "date", "service"]); ?>
