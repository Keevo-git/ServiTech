...
if ($context["ready"] && strtolower(trim((string)($_GET["export"] ?? ""))) === "csv") {
    analytics_send_csv_export($pdo, $context, "operations", "Operations Overview", "servitech-operations-overview.csv");
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Operations Overview | ServiTech</title>
  ...
  <link rel="stylesheet" href="<?= admin_url('/pages/super_admin/super_admin_analytics.css?v=20260701-compact-pagination') ?>">
</head>
...
<main class="container main-container analytics-page analytics-report-page">
  <?php analytics_render_report_header("Operations Overview", "Review overall system activity, completion rate, active workload, and current monthly analytics cycle.", $context); ?>
  ...
  <?php else: ?>
    <?php analytics_render_filters($context, "super_admin_analytics_operations.php", ["cycle", "date", "status"]); ?>
    <?php analytics_render_export_row($context, "super_admin_analytics_operations.php"); ?>
    <?php analytics_render_operations($context); ?>
  <?php endif; ?>
</main>
