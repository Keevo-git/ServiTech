...
<head>
  ...
  <title>Store Availability & Cutoff | ServiTech</title>
...
<main class="container main-container analytics-page analytics-report-page">
  <?php analytics_render_report_header("Store Availability & Cutoff", "Review store open/closed history, cutoff-related blocked requests, and availability changes.", $context); ?>
  ...
  <?php else: ?>
    ...
    <?php analytics_render_filters($context, "super_admin_analytics_availability.php", ["cycle", "date"]); ?>
    <?php analytics_render_availability($context); ?>
    <?php analytics_render_export_row($context, "super_admin_analytics_availability.php"); ?>
  <?php endif; ?>
</main>
