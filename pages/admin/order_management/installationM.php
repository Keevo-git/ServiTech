...
<head>
  ...
  <link rel="stylesheet" href="<?= admin_url('/pages/admin/order_management/orderM.css?v=20260530-modal-status-badge') ?>">
  <script src="<?= admin_url('/pages/admin/order_management/orderM.js?v=20260530-modal-status-badge') ?>" defer></script>
</head>
