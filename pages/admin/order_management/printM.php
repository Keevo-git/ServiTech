...
if (strtolower(trim((string)($_GET["view"] ?? ""))) === "walkin") {
    header("Location: " . admin_url_raw("/pages/admin/order_management/printM.php"));
    exit();
}
...
<head>
  ...
  <link rel="stylesheet" href="<?= admin_url('/pages/admin/order_management/orderM.css?v=20260618-close-button-circle') ?>">
            ...
            <div class="table-section">
              ...
              <div class="table-scroll-wrapper">
                <table id="onlineOrdersTable" class="orders table-content order-table order-table--online">
                  ...
                  <tbody>
                    <?php if (!$online): ?>
                      <tr><td colspan="6" style="color:#777;padding:14px;">No printing orders yet.</td></tr>
                    <?php else: ?>
