...
<head>
  ...
  <link rel="stylesheet" href="<?= admin_url('/pages/admin/queue_list/css/queueL.css?v=20260602-fifo-modal-layout') ?>">
...
<script src="<?= admin_url('/pages/admin/queue_list/queueL.js?v=20260602-fifo-modal-layout') ?>" defer></script>
