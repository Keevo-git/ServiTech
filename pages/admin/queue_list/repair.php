...
<head>
  ...
  <link rel="stylesheet" href="<?= admin_url('/pages/admin/queue_list/css/queueL.css?v=20260601-detail-list-comments') ?>">
  ...
  <div class="page-frame">
    <div class="page-inner">
      <div class="panel">
        ...
        <?php queue_ui_render_filter_toolbar("repairQueueTable"); ?>
        <div class="table-scroll-wrapper">
          <table id="repairQueueTable" class="table-content queue-table queue-table--simple">
          <thead>
            <tr>
              <th>Order ID</th>
              <th>Customer Name</th>
              ...
              <tr<?= queue_ui_row_attrs($r) ?>>
                ...
                <td class="actions">
                  <button
                    ...
                    type="button"
                    data-queue="<?= queue_ui_payload_attr($r, "Repair Service") ?>"
                  >View</button>
...
<script src="<?= admin_url('/pages/admin/queue_list/queueL.js?v=20260601-detail-list-comments') ?>" defer></script>
