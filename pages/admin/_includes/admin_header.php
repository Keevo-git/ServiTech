...
<script src="<?= admin_url('/assets/js/header-menu.js?v=20260607-logout-confirm') ?>" defer></script>
<script src="<?= admin_url('/pages/admin/admin_logout_confirm.js?v=20260607-admin-logout-confirm') ?>" defer></script>
