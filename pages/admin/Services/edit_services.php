...
<head>
  ...
  <link rel="stylesheet" href="<?= admin_url('/pages/admin/Services/manage_services.css?v=20260623-ui-controls-cleanup') ?>">
</head>
<body>
...
<script src="<?= admin_url('/pages/admin/Services/manage_services.js?v=20260623-ui-controls-cleanup') ?>"></script>
