...
servitech_operational_redirect_customer_unavailable_service($pdo, "repair", $repairServiceName, "/pages/customer/customer_dash.php");
...
servitech_operational_redirect_customer_unavailable_service($pdo, "repair", $repairServiceName, "/pages/customer/customer_dash.php", $repairServiceId);
?>
