<?php
require_once __DIR__ . "/../_includes/session_check.php";
...
$countStmt->execute([$session_user_id]);
...
$stmt = $pdo->prepare("
  ...
  LIMIT ? OFFSET ?
");
$stmt->execute([$session_user_id, $perPage, $offset]);
...
<head>
  ...
  <title>Notifications - ServiTech</title>
  <link rel="icon" type="images/png" href="/assets/images/favicon.png">
  <link rel="stylesheet" href="/assets/css/style.css?v=20260530base">
  <style>
    .notif-container {
      max-width: 800px;
      margin: 0 auto;
...
<div class="notif-container">
  <div class="back-link">
    <a href="<?= admin_url("/pages/customer/customer_dash.php") ?>">← Back to Dashboard</a>
  </div>
