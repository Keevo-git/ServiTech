...
<head>
  ...
  <style>
    ...
    body.customer-page--profile .navbar,
    body.customer-page--profile .navbar.has-nav-menu,
    body.customer-page--profile .navbar.has-nav-menu.navbar--notifications {
    ...
    body.customer-page--profile .profile-edit-page {
      ...
      padding: clamp(1.25rem, 2.6vw, 2rem) 0 clamp(2rem, 5vw, 3.5rem);
      overflow-x: clip;
    ...
    body.customer-page--profile .btn-primary,
    body.customer-page--profile .btn-secondary,
    body.customer-page--profile .back-link {
      min-height: 48px;
      display: inline-flex;
      align-items: center;
    ...
    body.customer-page--profile .modal-overlay {
      overflow-y: auto;
    ...
    body.customer-page--profile .confirm-modal.active {
      display: grid;
    ...
    body.customer-page--profile .confirm-modal__actions .btn-secondary,
    body.customer-page--profile .confirm-modal__actions .btn-primary,
    body.customer-page--profile .password-modal__actions .btn-secondary,
    body.customer-page--profile .password-modal__actions .btn-primary {
      min-width: 0;
      min-height: 52px;
      padding-inline: 1rem;
      white-space: normal;
    ...
    body.customer-page--profile .password-modal__field-grid {
      grid-template-columns: minmax(0, 1fr);
    }
    ...
    @media (max-width: 480px) {
      ...
      body.customer-page--profile .confirm-modal__close {
        top: 0.75rem;
        right: 0.75rem;
        width: 44px;
        height: 44px;
    ...
    @media (max-width: 380px) {
      ...
      body.customer-page--profile .confirm-modal__field {
        padding: 0.85rem;
      }
    }
    ...
    @media (max-height: 520px) and (orientation: landscape) {
      ...
      body.customer-page--profile .confirm-modal__header p {
        line-height: 1.45;
      }
    }
  </style>
